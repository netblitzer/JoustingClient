...
const init = () => {
  ...
  randomButton.on('pointerdown', function () {
  ...
  waitingCloseButton.on('pointerdown', function () {
      ...
      switch(state) {
        ...
        case 'matchWaiting':
          ...
          if (wS !== undefined) {
            ...
            coverStages.arenaWaitingOnMatch.waitingMenu.text.text = Math.floor(coverStages.arenaWaitingOnMatch.waitTime);
